...
class RPConfiguration(RPUnit):
    ...
    def get_additional_sources(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getAdditionalSources", "additionalSources"))
    ...
    def get_build_set(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getBuildSet", "buildSet"))
    ...
    def get_compiler_switches(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getCompilerSwitches", "compilerSwitches"))
    ...
    def get_directory(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getDirectory", "directory"))
    ...
    def get_executable_name(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getExecutableName", "executableName"))
    ...
    def get_include_path(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getIncludePath", "includePath"))
    ...
    def get_initialization_code(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getInitializationCode", "initializationCode"))
    ...
    def get_libraries(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getLibraries", "libraries"))
    ...
    def get_link_switches(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getLinkSwitches", "linkSwitches"))
    ...
    def get_main_name(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getMainName", "mainName"))
    ...
    def get_makefile_name(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getMakefileName", "makefileName"))
    ...
    def get_path(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getPath", "path"))
    ...
    def get_standard_headers(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getStandardHeaders", "standardHeaders"))
    ...
    def get_target_name(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getTargetName", "targetName"))
