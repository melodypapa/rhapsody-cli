...
class RPComponent(RPUnit):
    ...
    def get_build_type(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getBuildType", "buildType"))
    ...
    def get_file_name(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getFileName", "fileName"))
    ...
    def get_model_element_file_name(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getModelElementFileName", "modelElementFileName"))
    ...
    def get_package_file(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getPackageFile", "packageFile"))
    ...
    def get_variant(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getVariant", "variant"))
