...
class RPPackage(RPUnit):
    ...
    # --- Association methods ---
    def add_association(self, name: str) -> "RPRelation":  # type: ignore
    ...
    def get_events_base_id(self) -> str:
        ...
        """
        return cast(str, AbstractRPModelElement._get_method_or_property(self._com, "getEventsBaseId", "eventsBaseId"))
    ...
    def get_namespace(self) -> str:
        ...
        """
        return cast(str, AbstractRPModelElement._get_method_or_property(self._com, "getNamespace", "namespace"))
