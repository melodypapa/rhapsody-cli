...
class RPConnector(RPStateVertex):
    ...
    def get_connector_type(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getConnectorType", "connectorType"))
...
class RPGraphElement(RPModelElement):
    ...
    def get_associated_image(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getAssociatedImage", "associatedImage"))
    ...
    def get_image_layout(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getImageLayout", "imageLayout"))
    ...
    def get_interface_name(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getInterfaceName", "interfaceName"))
    ...
    def get_property_value(self, property_key: str) -> str:
        ...
        """
        return cast(str, self.call_com(lambda: self._com.getPropertyValue(property_key)))
    ...
    def get_selected_image(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getSelectedImage", "selectedImage"))
...
class RPGraphicalProperty(RPModelElement):
    ...
    def get_key(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getKey", "key"))
    ...
    def get_value(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getValue", "value"))
...
class RPImageMap(RPModelElement):
    ...
    def get_name(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getName", "name"))
    ...
    def get_picture_file_name(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getPictureFileName", "pictureFileName"))
    ...
    def get_points(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getPoints", "points"))
    ...
    def get_shape(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getShape", "shape"))
    ...
    def get_target(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getTarget", "target"))
...
class RPLink(RPUnit):
    ...
    def get_end1_multiplicity(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getEnd1Multiplicity", "end1Multiplicity"))
    ...
    def get_end1_name(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getEnd1Name", "end1Name"))
    ...
    def get_end2_multiplicity(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getEnd2Multiplicity", "end2Multiplicity"))
    ...
    def get_end2_name(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getEnd2Name", "end2Name"))
...
class RPMatrixView(RPUnit):
    ...
    def get_cell_string(self, row: int, column: int) -> str:
        ...
        """
        return cast(str, self.call_com(lambda: self._com.getCellString(row, column)))
    ...
    def get_content(self, format_: str) -> str:
        ...
        """
        return cast(str, self.call_com(lambda: self._com.getContent(format_)))
    ...
    def get_html_content(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getHTMLContent", "hTMLContent"))
...
class RPMessagePoint(RPModelElement):
    ...
    def get_type(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getType", "type"))
...
class RPTableLayout(RPUnit):
    ...
    def get_column_context(self, index: int) -> str:
        ...
        """
        return cast(str, self.call_com(lambda: self._com.getColumnContext(index)))
    ...
    def get_column_implementation_cell_type(self, index: int) -> str:
        ...
        """
        return cast(str, self.call_com(lambda: self._com.getColumnImplementationCellType(index)))
    ...
    def get_column_implementation_display_property(self, index: int) -> str:
        ...
        """
        return cast(str, self.call_com(lambda: self._com.getColumnImplementationDisplayProperty(index)))
    ...
    def get_column_implementation_getter_code(self, index: int) -> str:
        ...
        """
        return cast(str, self.call_com(lambda: self._com.getColumnImplementationGetterCode(index)))
    ...
    def get_column_implementation_imports(self, index: int) -> str:
        ...
        """
        return cast(str, self.call_com(lambda: self._com.getColumnImplementationImports(index)))
    ...
    def get_column_implementation_picker_code(self, index: int) -> str:
        ...
        """
        return cast(str, self.call_com(lambda: self._com.getColumnImplementationPickerCode(index)))
    ...
    def get_column_implementation_setter_code(self, index: int) -> str:
        ...
        """
        return cast(str, self.call_com(lambda: self._com.getColumnImplementationSetterCode(index)))
    ...
    def get_column_name(self, index: int) -> str:
        ...
        """
        return cast(str, self.call_com(lambda: self._com.getColumnName(index)))
    ...
    def get_column_property(self, index: int) -> str:
        ...
        """
        return cast(str, self.call_com(lambda: self._com.getColumnProperty(index)))
    ...
    def get_column_type(self, index: int) -> str:
        ...
        """
        return cast(str, self.call_com(lambda: self._com.getColumnType(index)))
...
class RPPin(RPConnector):
    ...
    def get_pin_direction(self) -> str:
        ...
        """
        return cast(str, self._get_method_or_property(self._com, "getPinDirection", "pinDirection"))
