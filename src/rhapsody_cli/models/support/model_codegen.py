...
class RPBaseExternalCodeGeneratorTool(RPModelElement):
    ...
    def should_abort_code_generation(self) -> int:
        ...
        """
        return self.call_com(lambda: self._com.shouldAbortCodeGeneration())  # type: ignore[no-any-return]
...
class RPDiagSynthAPI(RPModelElement):
    ...
    def add_instance(self, added_to_s_d: int, instance_nav_exp: str) -> int:
        ...
        """
        return self.call_com(lambda: self._com.addInstance(added_to_s_d, instance_nav_exp))  # type: ignore[no-any-return]
    ...
    def add_synth_sd_to_model2(self, p_msc_orig: "RPSequenceDiagram", synth_s_d: int, open_s_d: int) -> int:
        ...
        """
        return self.call_com(lambda: self._com.addSynthSDToModel2(p_msc_orig._com, synth_s_d, open_s_d))  # type: ignore[no-any-return]
    ...
    def create_sd2(self, p_msc_orig: "RPSequenceDiagram", testedmscname: str) -> int:
        ...
        """
        return self.call_com(lambda: self._com.createSD2(p_msc_orig._com, testedmscname))  # type: ignore[no-any-return]
    ...
    def remove_synth_sd_to_model2(self, p_msc_orig: "RPSequenceDiagram") -> int:
        ...
        """
        return self.call_com(lambda: self._com.removeSynthSDToModel2(p_msc_orig._com))  # type: ignore[no-any-return]
    ...
    def s_d_add_condition_mark(self, p_tested_s_d: int, instance: str, text: str, type_: str) -> int:
        ...
        """
        return self.call_com(lambda: self._com.sDAddConditionMark(p_tested_s_d, instance, text, type_))  # type: ignore[no-any-return]
    ...
    def send_message(self, p_tested_s_d: int, source: str, target: str, event: str, operation: str, type_: str) -> int:
        ...
        """
        return self.call_com(lambda: self._com.sendMessage(p_tested_s_d, source, target, event, operation, type_))  # type: ignore[no-any-return]
...
class RPSearchQuery(RPModelElement):
    ...
    def add_diagram_to_views_list(self, view: "RPDiagram") -> int:
        ...
        """
        return self.call_com(lambda: self._com.addDiagramToViewsList(view._com))  # type: ignore[no-any-return]
    ...
    def add_matrix_to_views_list(self, view: "RPMatrixView") -> int:
        ...
        """
        return self.call_com(lambda: self._com.addMatrixToViewsList(view._com))  # type: ignore[no-any-return]
    ...
    def add_table_to_views_list(self, view: "RPTableView") -> int:
        ...
        """
        return self.call_com(lambda: self._com.addTableToViewsList(view._com))  # type: ignore[no-any-return]
    ...
    def get_filter_sub_query_use_with_not_operator(self, sub_query: "RPTableLayout") -> int:
        ...
        """
        return self.call_com(lambda: self._com.getFilterSubQueryUseWithNotOperator(sub_query._com))  # type: ignore[no-any-return]
    ...
    def remove_filter_sub_query(self, sub_query: "RPTableLayout") -> int:
        ...
        """
        return self.call_com(lambda: self._com.removeFilterSubQuery(sub_query._com))  # type: ignore[no-any-return]
    ...
    def remove_search_scope_element(self, scope_element: "RPModelElement") -> int:
        ...
        """
        return self.call_com(lambda: self._com.removeSearchScopeElement(scope_element._com))  # type: ignore[no-any-return]
